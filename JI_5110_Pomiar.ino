...
void setup()   {
  ...
  lightMeter.begin();  //inicjacja pomiaru oswietlenia
  Serial.println("Running..."); // Drukowanie na Terminalu
  ...
  display.setContrast(55);    //bylo na poczatku 50
...
//  display.println("Hello, Jurek!");
 // display.setTextColor(WHITE, BLACK); // 'inverted' text
//  display.println(3,141592);
//  display.setTextSize(2);
//  display.setTextColor(BLACK);
//  display.print("0x"); display.println(0xDEADB, HEX);
//  display.println("Zosia");
//  display.display();
//  delay(2000);
//  display.clearDisplay();
...
//  testdrawbitmap(logo16_glcd_bmp, LOGO16_GLCD_WIDTH, LOGO16_GLCD_HEIGHT);
 ...
 void loop() {
  ...
  display.setTextSize(1);
  display.setTextColor(BLACK);
  display.setCursor(0,0); //5 przesuniecie w prawo, 2 przesuniecie do dolu
  display.println("Pomiary");
  display.println(" ");
  display.print("Tem:");
